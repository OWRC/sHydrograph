...
shinyApp(
  ...
  server <- function(input, output, session){
    ...
    # collect_interval(-847483634) #(42065) #(-2087447190) #(-1079041667) #(-2141014609) # (-970785621) #(10694) #(37679) #(730800020) #("[120000006,1003537998,730800020,360000475") #(148405,5) #(148014,3) #("[148014,360000026]",3) #
    observe({
