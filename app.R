...
shinyApp(
  ...
  server <- function(input, output, session){
    ...
    collect_interval(730800020) #1099646144) #("test/1099646144.json") #(-1741125310,3) #("test/-1741125310.txt") #(730800020) #(148842) #(-373572324) #(-2056054271,5) #(-373572324) #(-498465806) #(-1261492764) #(-224406311) #(-130212055) #
    # observe({
