...
shinyApp(
  ...
  server <- function(input, output, session){
    ...
    ###################
    ### Load station ID:
    ### http://shinyapps.canadacentral.cloudapp.azure.com:3838/sHydrograph/?i=240000054
    ...
    # collect_interval(-373572324) #(240000054) #(-498465806) #(-373572324) #(-1261492764) #(148842) #(-224406311) #(-130212055) #
    observe({
