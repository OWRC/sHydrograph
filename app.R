...
shinyApp(
  ...
  server <- function(input, output, session){
    ...
    # collect_interval(148842) #(83764) #(-373572324) #(-1741125310,3) #("test/1099646144.json") #(6994) #(1697639961) #(-1741125310,3) #("test/-1741125310.txt") #(730800020) #(148842) #(-2056054271,5) #(-498465806) #(-1261492764) #(-224406311) #
    observe({
