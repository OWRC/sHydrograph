...
source(file.path("srv/temporal/main", "srv_main_ggplot.R"), local = TRUE)$value
source(file.path("srv/temporal/main", "srv_main_dygraph.R"), local = TRUE)$value
source(file.path("srv/temporal/main", "srv_main_leaflet.R"), local = TRUE)$value
...
source(file.path("srv/trends", "srv_breakout.R"), local = TRUE)$value
